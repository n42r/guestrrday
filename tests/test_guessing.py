...
from guestrrday.guestrrday import guess_track, guess_by_tracklist, guess_by_dir
...
def test_guess_all_fail():
	...
	assert guess_track(tr) is None
	assert guess_track(tr2) is None
	shutil.rmtree('tests/temp/')
